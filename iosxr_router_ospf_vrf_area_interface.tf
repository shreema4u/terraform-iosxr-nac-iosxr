        ...
        for vrf in try(ospf_process.vrfs, []) : [
          for area in try(vrf.areas, []) : [
            for interface in try(area.interfaces, []) : {
              key                                                             = format("%s/%s/%s/%s/%s", device.name, ospf_process.id, vrf.vrf_name, area.area_id, interface.interface_name)
              ...
              interface_name                                                  = try(interface.interface_name, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.interface_name, null)
              authentication_key_encrypted                                    = try(interface.authentication_key_encrypted, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.authentication_key_encrypted, null)
              authentication_message_digest                                   = try(interface.authentication_message_digest, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.authentication_message_digest, null)
              authentication_keychain_name                                    = try(interface.authentication_keychain_name, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.authentication_keychain_name, null)
              authentication_keychain                                         = try(interface.authentication_keychain, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.authentication_keychain, null)
              authentication_null                                             = try(interface.authentication_null, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.authentication_null, null)
              ...
              mpls_ldp_sync                                                   = try(interface.mpls_ldp_sync, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.mpls_ldp_sync, null)
              mpls_ldp_sync_disable                                           = try(interface.mpls_ldp_sync_disable, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.mpls_ldp_sync_disable, null)
              ...
              cost_fallback                                                   = try(interface.cost_fallback, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.cost_fallback, null)
              cost_fallback_threshold                                         = try(interface.cost_fallback_threshold, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.cost_fallback_threshold, null)
              cost_fallback_anomaly_delay_igp_metric_increment                = try(interface.cost_fallback_anomaly_delay_igp_metric_increment, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.cost_fallback_anomaly_delay_igp_metric_increment, null)
              cost_fallback_anomaly_delay_igp_metric_multiplier               = try(interface.cost_fallback_anomaly_delay_igp_metric_multiplier, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.cost_fallback_anomaly_delay_igp_metric_multiplier, null)
              cost_fallback_anomaly_delay_igp_metric_value                    = try(interface.cost_fallback_anomaly_delay_igp_metric_value, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.cost_fallback_anomaly_delay_igp_metric_value, null)
              cost_fallback_anomaly_delay_igp_metric_disable                  = try(interface.cost_fallback_anomaly_delay_igp_metric_disable, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.cost_fallback_anomaly_delay_igp_metric_disable, null)
              cost_fallback_anomaly_delay_te_metric_increment                 = try(interface.cost_fallback_anomaly_delay_te_metric_increment, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.cost_fallback_anomaly_delay_te_metric_increment, null)
              cost_fallback_anomaly_delay_te_metric_multiplier                = try(interface.cost_fallback_anomaly_delay_te_metric_multiplier, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.cost_fallback_anomaly_delay_te_metric_multiplier, null)
              cost_fallback_anomaly_delay_te_metric_value                     = try(interface.cost_fallback_anomaly_delay_te_metric_value, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.cost_fallback_anomaly_delay_te_metric_value, null)
              cost_fallback_anomaly_delay_te_metric_disable                   = try(interface.cost_fallback_anomaly_delay_te_metric_disable, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.cost_fallback_anomaly_delay_te_metric_disable, null)
              ...
              flood_reduction_enable                                          = try(interface.flood_reduction_enable, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.flood_reduction_enable, null)
              flood_reduction_disable                                         = try(interface.flood_reduction_disable, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.flood_reduction_disable, null)
              demand_circuit_enable                                           = try(interface.demand_circuit_enable, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.demand_circuit_enable, null)
              demand_circuit_disable                                          = try(interface.demand_circuit_disable, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.demand_circuit_disable, null)
              mtu_ignore_enable                                               = try(interface.mtu_ignore_enable, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.mtu_ignore_enable, null)
              mtu_ignore_disable                                              = try(interface.mtu_ignore_disable, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.mtu_ignore_disable, null)
              database_filter_all_out_enable                                  = try(interface.database_filter_all_out_enable, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.database_filter_all_out_enable, null)
              database_filter_all_out_disable                                 = try(interface.database_filter_all_out_disable, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.database_filter_all_out_disable, null)
              ...
              security_ttl                                                    = try(interface.security_ttl, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.security_ttl, null)
              ...
              security_ttl_disable                                            = try(interface.security_ttl_disable, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.security_ttl_disable, null)
              prefix_suppression                                              = try(interface.prefix_suppression, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.prefix_suppression, null)
              prefix_suppression_disable                                      = try(interface.prefix_suppression_disable, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.prefix_suppression_disable, null)
              ...
              fast_reroute_per_link_use_candidate_only_enable                 = try(interface.fast_reroute_per_link.use_candidate_only_enable, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.fast_reroute_per_link.use_candidate_only_enable, null)
              fast_reroute_per_link_use_candidate_only_disable                = try(interface.fast_reroute_per_link.use_candidate_only_disable, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.fast_reroute_per_link.use_candidate_only_disable, null)
              ...
              fast_reroute_per_prefix_use_candidate_only_enable               = try(interface.fast_reroute_per_prefix.use_candidate_only_enable, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.fast_reroute_per_prefix.use_candidate_only_enable, null)
              fast_reroute_per_prefix_use_candidate_only_disable              = try(interface.fast_reroute_per_prefix.use_candidate_only_disable, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.fast_reroute_per_prefix.use_candidate_only_disable, null)
              ...
              loopback_stub_network_enable                                    = try(interface.loopback_stub_network_enable, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.loopback_stub_network_enable, null)
              loopback_stub_network_disable                                   = try(interface.loopback_stub_network_disable, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.loopback_stub_network_disable, null)
              ...
              prefix_sid_index                                                = try(interface.prefix_sid_index, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.prefix_sid_index, null)
              prefix_sid_index_explicit_null                                  = try(interface.prefix_sid_index_explicit_null, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.prefix_sid_index_explicit_null, null)
              prefix_sid_index_n_flag_clear                                   = try(interface.prefix_sid_index_n_flag_clear, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.prefix_sid_index_n_flag_clear, null)
              prefix_sid_absolute                                             = try(interface.prefix_sid_absolute, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.prefix_sid_absolute, null)
              prefix_sid_absolute_explicit_null                               = try(interface.prefix_sid_absolute_explicit_null, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.prefix_sid_absolute_explicit_null, null)
              prefix_sid_absolute_n_flag_clear                                = try(interface.prefix_sid_absolute_n_flag_clear, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.prefix_sid_absolute_n_flag_clear, null)
              prefix_sid_strict_spf_index                                     = try(interface.prefix_sid_strict_spf_index, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.prefix_sid_strict_spf_index, null)
              prefix_sid_strict_spf_index_explicit_null                       = try(interface.prefix_sid_strict_spf_index_explicit_null, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.prefix_sid_strict_spf_index_explicit_null, null)
              prefix_sid_strict_spf_index_n_flag_clear                        = try(interface.prefix_sid_strict_spf_index_n_flag_clear, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.prefix_sid_strict_spf_index_n_flag_clear, null)
              prefix_sid_strict_spf_absolute                                  = try(interface.prefix_sid_strict_spf_absolute, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.prefix_sid_strict_spf_absolute, null)
              prefix_sid_strict_spf_absolute_explicit_null                    = try(interface.prefix_sid_strict_spf_absolute_explicit_null, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.prefix_sid_strict_spf_absolute_explicit_null, null)
              prefix_sid_strict_spf_absolute_n_flag_clear                     = try(interface.prefix_sid_strict_spf_absolute_n_flag_clear, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.prefix_sid_strict_spf_absolute_n_flag_clear, null)
              ...
              message_digest_keys = try(length(interface.message_digest_keys) == 0, true) ? null : [for key in interface.message_digest_keys : {
                key_id        = try(key.key_id, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.message_digest_keys.key_id, null)
                md5_encrypted = try(key.md5_encrypted, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.message_digest_keys.md5_encrypted, null)
              }]
              fast_reroute_per_link_exclude_interfaces = try(length(interface.fast_reroute_per_link.exclude_interfaces) == 0, true) ? null : [for iface in interface.fast_reroute_per_link.exclude_interfaces : {
                interface_name = try(iface.interface_name, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.fast_reroute_per_link.exclude_interfaces.interface_name, null)
              }]
              fast_reroute_per_link_lfa_candidate_interfaces = try(length(interface.fast_reroute_per_link.lfa_candidate_interfaces) == 0, true) ? null : [for iface in interface.fast_reroute_per_link.lfa_candidate_interfaces : {
                interface_name = try(iface.interface_name, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.fast_reroute_per_link.lfa_candidate_interfaces.interface_name, null)
              }]
              fast_reroute_per_prefix_exclude_interfaces = try(length(interface.fast_reroute_per_prefix.exclude_interfaces) == 0, true) ? null : [for iface in interface.fast_reroute_per_prefix.exclude_interfaces : {
                interface_name = try(iface.interface_name, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.fast_reroute_per_prefix.exclude_interfaces.interface_name, null)
              }]
              fast_reroute_per_prefix_lfa_candidate_interfaces = try(length(interface.fast_reroute_per_prefix.lfa_candidate_interfaces) == 0, true) ? null : [for iface in interface.fast_reroute_per_prefix.lfa_candidate_interfaces : {
                interface_name = try(iface.interface_name, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.fast_reroute_per_prefix.lfa_candidate_interfaces.interface_name, null)
              }]
              prefix_sid_algorithms = try(length(interface.prefix_sid_algorithms) == 0, true) ? null : [for alg in interface.prefix_sid_algorithms : {
                algorithm_number       = try(alg.algorithm_number, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.prefix_sid_algorithms.algorithm_number, null)
                index                  = try(alg.index, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.prefix_sid_algorithms.index, null)
                index_explicit_null    = try(alg.index_explicit_null, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.prefix_sid_algorithms.index_explicit_null, null)
                index_n_flag_clear     = try(alg.index_n_flag_clear, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.prefix_sid_algorithms.index_n_flag_clear, null)
                absolute               = try(alg.absolute, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.prefix_sid_algorithms.absolute, null)
                absolute_explicit_null = try(alg.absolute_explicit_null, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.prefix_sid_algorithms.absolute_explicit_null, null)
                absolute_n_flag_clear  = try(alg.absolute_n_flag_clear, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.prefix_sid_algorithms.absolute_n_flag_clear, null)
              }]
              adjacency_sid_indexes = try(length(interface.adjacency_sid_indexes) == 0, true) ? null : [for idx in interface.adjacency_sid_indexes : {
                sid_index        = try(idx.sid_index, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.adjacency_sid_indexes.sid_index, null)
                protected        = try(idx.protected, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.adjacency_sid_indexes.protected, null)
                neighbor_address = try(idx.neighbor_address, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.adjacency_sid_indexes.neighbor_address, null)
              }]
              adjacency_sid_absolutes = try(length(interface.adjacency_sid_absolutes) == 0, true) ? null : [for abs in interface.adjacency_sid_absolutes : {
                sid_label        = try(abs.sid_label, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.adjacency_sid_absolutes.sid_label, null)
                protected        = try(abs.protected, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.adjacency_sid_absolutes.protected, null)
                neighbor_address = try(abs.neighbor_address, local.defaults.iosxr.devices.configuration.routing.ospf_processes.vrfs.areas.interfaces.adjacency_sid_absolutes.neighbor_address, null)
              }]
            }
          ]
        ]
